...
allarr = np.genfromtxt(scanfile, usecols=(1,2,7,16,272,273 ), delimiter='|', converters={7:nulltonan,16:nulltonan,286:nulltonan,287:nulltonan}).transpose()
...
print "Now applying jm2mass cut(s)"
